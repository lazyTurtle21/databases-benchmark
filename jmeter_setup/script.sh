...
for i in {1..10}; do echo aaaaaa$i && jmeter -n -t PostgreSQL_DELETE.jmx; done
...
for i in {1..10}; do echo aaaaaa$i && jmeter -n -t MongoDB_DELETE.jmx; done
...
for i in {1..10}; do echo aaaaaa$i && jmeter -n -t MySQL_DELETE.jmx; done
